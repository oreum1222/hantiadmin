...
window.CONFIG = {
  ...
  STAFF: ['가경T', '다미', '채현', '경은', '규민', '재희'],

  // 공지 발송 주체 (연구소 내부 + 학원 측 발송 구분)
  NOTICE_SENDERS: ['가경T', '학원(MEXX)', '다미', '채현', '경은', '규민', '재희'],

  // 출결 상태 (보강 = 결석 후 보강으로 출석 인정)
  ATT_STATUSES: ['출석', '지각', '결석', '보강', '사유', '온라인'],
  ...
  MEXX_COURSES: ['h1', 'h2', 'sh1', 'sm3', 'g2cs', 'g2he', 'g2chuseok'],
